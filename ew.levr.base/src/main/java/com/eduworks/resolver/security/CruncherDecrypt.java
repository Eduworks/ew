...
public class CruncherDecrypt extends Cruncher
{
	@Override
	public Object resolve(Context c, Map<String, String[]> parameters, Map<String, InputStream> dataStreams) throws JSONException
	{
		try
		{
			return decrypt(getAsString("salt", c, parameters, dataStreams), c, parameters, dataStreams);
		}
	...
	private static byte[] getKeyBytes()
	{
		...
		for (int i = 0; i < key.length; i++)
			key[i] = (i % 2 == 0) ? (byte) (Byte.MAX_VALUE - (i % 7 * 10)) : (byte) (Byte.MIN_VALUE + (i % 7 * 10));
	...
	public String decrypt(String salt, Context c, Map<String, String[]> parameters, Map<String, InputStream> dataStreams) throws GeneralSecurityException,
			JSONException
	{
		return decrypt(getAsString(VALUE, c, parameters, dataStreams), optAsString(KEY, null, c, parameters, dataStreams), salt);
	}

	public String encrypt(String salt, Context c, Map<String, String[]> parameters, Map<String, InputStream> dataStreams) throws GeneralSecurityException,
			JSONException
	{
