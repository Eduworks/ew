...
//		}
     ...
     * @param identifier - Identifier of the ontology (right now this is the filename
...
//		EwCache.getCache("OntologyCache", 20).put(identifier, o);
     ...
     * @param identifier - The identifier of the new ontology (right now, just the name
     ...
     * and saves the
     *
     * @param o       - OntModel to be wrapped
     * @param dataSet
     */
     ...
     *
     * @param classId - Id of the class that will be retrieved
     ...
     *
     * @param classId - Id of the class that is to be instantiated
     * @param values  - values of the properties for the new instance
    ...
    public OntologyInstance getInstance(String instanceId, boolean local) {
        ...
        if (instanceId.startsWith("http")) {
            ...
            for (org.apache.jena.ontology.Ontology o : jenaModel.listOntologies().toSet()) {
                ...
                if (debug)
                    System.out.println("Get Instance (CreateResource) took: " + (System.currentTimeMillis() - dt2) + " millis.");
            }
        }
     ...
     *
     * @param propertyId - identifier of the property that we want to retrieve
    ...
    public JSONArray findShortestPath(String startId, String endId, JSONArray pathRelationships) {
        ...
        Predicate<Statement> filter = new OntTools.PredicatesFilter(props);
